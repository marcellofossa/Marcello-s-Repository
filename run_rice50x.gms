...
$title  RICE50+
$ontext
This is an extension of the DICE-2016 model, with up to 57 regions (reflecting
...
Full documentation available at: [still undergoing]
$offtext
$eolcom #
...
## ASYNCHRONUS SOLVE OPTION
$setGlobal option holdFixedAsync 1

## RESULT FINAL FILENAME
$setglobal nameout "cea_ssp2 _burke_inertia10"
...
## POLICY
* Select policy scenario among
*| bau | bau-impacts | cba | sim | cba-ndcs | cea-cbudget | cea-tatm |
$setglobal policy 'cea-tatm'
...
## REGION DETAIL
*| ed57 | ed35 | witch17 | witch13 | r5 | global |
$setglobal n 'witch13'
...
* temp path  (useful for debug and essential for coalitions mode)
